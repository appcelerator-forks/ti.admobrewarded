...
#include "net.birdirbir.admobrewarded.RewardedVideoProxy.h"
	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"net.birdirbir.admobrewarded.AdmobrewardedModule", ::net::birdirbir::admobrewarded::AdmobrewardedModule::bindProxy, ::net::birdirbir::admobrewarded::AdmobrewardedModule::dispose},
				{"net.birdirbir.admobrewarded.RewardedVideoProxy", ::net::birdirbir::admobrewarded::RewardedVideoProxy::bindProxy, ::net::birdirbir::admobrewarded::RewardedVideoProxy::dispose}
			};
